...
@include('frontend.includes.header.header_mobile')
@include('frontend.includes.header.header_top')
@include('frontend.includes.header.header_center')
@include('frontend.includes.header.header_bottom')
@include('frontend.includes.header.header_sticy')
...
<div id="displayTop" class="displaytopone">
    <div class="container">
        <div class="row">
            <div class="nov-row  nov_row-no-padding "  data-nov-full-width="true" data-nov-stretch-content="true"><div class="nov-row-wrap row">
