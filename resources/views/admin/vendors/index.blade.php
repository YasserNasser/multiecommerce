                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table
                                            class="table display  table-striped table-bordered table-hover scroll-horizontal">
                                            <thead>
                                            <tr>
                                                <th> الاسم</th>
                                                <th>صورة المتجر</th>
                                                    ...
                                                    <tr >
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group"
                                                                ...
                                                                class="btn btn-outline-warning  box-shadow-3 mr-1 mb-1">{{($vendor->active == 1) ? 'إلغاء تفعيل' : 'تفعيل'}}</a>
